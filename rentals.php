            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Payment Transaction</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Payment Transaction Lists</p>
                        </div>
                        <div class="card-body">
                ...
                <div class="modal-body">
                    <form action="functions/payment.php" method="post">
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="image" value="Cash">
                            <div class="form-floating mb-3">
                                <select class="form-select" name="month_paid" id="monthDropdown" required>
                                    <option value="">Select Month</option>
                                </select>
                                <label for="monthDropdown">Month</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control form-control" type="number" placeholder="Amount" min="1" name="amount">
                                <label class="form-label" for="floatingInput">Amount</label>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getMonthsBetween(startDate, endDate) {
                ...
                current.setDate(1); // to avoid month skip bug

                while (current <= end) {
                    const monthValue = current.toISOString().slice(0, 7); // format YYYY-MM
            ...
            $('a[data-bs-target="#pay"]').on('click', function() {
                ...
                $.getJSON('functions/get_month_paid.php', {
                    id: id
                }, function(paidMonths) {
                    $dropdown.empty().append('<option value="">Select Month</option>');
