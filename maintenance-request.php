            ...
            <div id="content">
                <div class="container-fluid mt-4">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <button class="btn btn-primary btn-icon-split" type="button" data-bs-target="#add" data-bs-toggle="modal"><span class="text-white-50 icon"><i class="fas fa-user-friends"></i></span><span class="text-white text">Request Maintenance</span></button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <?php include_once 'functions/views/maintenance-request.php' ?>
                                    </tbody>
                                    <tfoot>
                                        <tr></tr>
                                    </tfoot>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Request Maintenance</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="functions/add-request.php" method="POST" enctype="multipart/form-data">
                        <div class="container">
                            <div class="row">
                                <div class="form-floating mb-3"><input class="form-control form-control" type="text" placeholder="Request" name="request" required=""><label class="form-label" for="floatingInput">Request</label></div>

                                <input type="hidden" name="boarder_id" value="<?php echo $boarder_id; ?>">
