                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Payment Transaction</p>
                            </div>
                            <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="functions/payment.php" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <img src="assets/img/payment.jpg" alt="Payment Image" id="cimg" class="img-fluid img-thumbnail" style="max-width: 200px;">
                                </div>
                                ...
                                <div class="form-group d-flex flex-column align-items-center">
                                    <input type="file" name="image" id="attachment" class="form-control mb-2" accept="image/*">
                                    <img id="preview" src="#" alt="Image Preview" class="img-fluid img-thumbnail" style="max-width: 300px; display: none;">
                                </div>
