        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-room.php" method="POST" enctype="multipart/form-data">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="file" name="images[]" accept="image/*" multiple required="">
                                        <label class="form-label" for="floatingInput">Room Images (You can select multiple images)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
