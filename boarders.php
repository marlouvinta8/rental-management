                    ...
                    <form action="functions/add-boarder.php" method="POST" enctype="multipart/form-data">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" aria-label="Floating label select example" id="floatingSelect-username" name="email" required="">
                                            <?php username_list(); ?>
                                        </select>
                                        <label class="form-label" for="floatingSelect-username">Username</label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3"><input class="form-control form-control" placeholder="End Date" name="end_date" type="date" required=""><label class="form-label" for="floatingInput">End Date</label></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
