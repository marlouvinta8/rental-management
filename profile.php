                ...
                <div class="container-fluid"><span class="bs-icon-md bs-icon-rounded bs-icon-semi-white border rounded-circle border-primary-subtle shadow-lg d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-house-heart-fill">
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-original-title="Here you can see your Dashboard." data-bs-placement="bottom" href="rentals.php" style="color:#393939;" title="Here you can view and transact payments."><i class="fas fa-credit-card"></i>&nbsp;Payment Transaction</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-original-title="Here you can manage your account." data-bs-placement="bottom" href="request.php" style="color:#393939;" title="Here you can see the tenants maintenance request."><i class="fas fa-user-shield"></i>&nbsp;Maintenance Request</a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-original-title="Here you can manage users." data-bs-placement="bottom" href="users.php" style="color:#393939;" title="Here you can manage users."><i class="fas fa-users"></i>&nbsp;Users</a></li>
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 d-flex gap-2">
                                                <a class="btn btn-info" type="button" href="functions/<?= $proof_of_identity ?>">View Proof of Identity</a>

                                                <?php if ($status == 0): ?>
                                                    <!-- Form to submit POST request for approve -->
                                                    <form action="functions/approve-tenant.php" method="POST">
                                                        <input type="hidden" name="id" value="<?= $id ?>"> <!-- Ipasok ang user_id sa hidden field -->
                                                        <input type="hidden" name="room" value="<?= $room ?>">
                                                        <button type="submit" class="btn btn-primary">Approve</button>
                                                    </form>
                                                    <form action="functions/disapprove-tenant.php" method="POST">
                                                        <input type="hidden" name="id" value="<?= $id ?>"> <!-- Ipasok ang user_id sa hidden field -->
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Payment Request</p>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                            if (isset($_POST['approve_payment_id'])) {
                                                ...
                                                $update = $db->prepare("UPDATE payments SET is_approved = 1 WHERE id = ?");
                                ...
                                setTimeout(() => {
                                    window.location.href = 'reports.php';
                                            ...
                                            if (isset($_POST['reject_payment_id'])) {
                                                ...
                                                $update = $db->prepare("UPDATE payments SET is_approved = 2 WHERE id = ?");
                                                $update->execute([$paymentId]);
                            ...
                            <script>
                                ...
                                setTimeout(() => {
                                    window.location.href = 'reports.php';
                                        ...
                                        $sql = 'SELECT payments.id AS payment_id, payments.month_paid, boarders.*, rooms.id as room, rooms.rent as rent, payments.total, payments.amount, payments.payment_method
        FROM boarders
        INNER JOIN rooms ON boarders.room = rooms.id
        INNER JOIN payments ON boarders.id = payments.boarder
        WHERE boarders.id = ' . $id . ' AND payments.is_approved = 0';
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <img class="rounded-circle me-2" width="30" height="30" src="functions/<?= $row['profile_picture'] ?>">
                                                    <?= $row['fullname'] ?>
                                                </td>
                                                <td>Room # <?= $row['room'] ?></td>
                                                <td><?= $row['type'] ?></td>
                                                ...
                                                <td>
                                                    <?php if (!empty($row['payment_method'])): ?>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal" data-image="uploads/<?= $row['payment_method'] ?>">
                                                            <img src="uploads/<?= $row['payment_method'] ?>" alt="Payment Proof" width="50" height="50">
                                                        </a>
                                                    <?php else: ?>
                                                        No image
                                                    <?php endif; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <form method="POST" onsubmit="return confirm('Reject this payment?');" style="display:inline;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <img id="modalImage" src="" class="img-fluid" alt="Large Payment Proof">
                </div>
            </div>
        </div>
    </div>
