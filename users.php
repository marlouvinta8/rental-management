            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">User Management</h3><button class="btn btn-primary btn-icon-split" type="button" data-bs-target="#add" data-bs-toggle="modal"><span class="text-white-50 icon"><i class="fas fa-user-plus"></i></span><span class="text-white text">Add User</span></button>
                    </div>
                    ...
                    <form action="functions/add-user.php" method="POST">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="text" placeholder="Full Name" name="name" required="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="text" placeholder="Username" name="username" required="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="password" placeholder="Password" name="password" required="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="text" placeholder="Email" name="email" required="">
                    ...
                    <form action="functions/update-user.php" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="password" placeholder="Password" name="password">
                                        <label class="form-label" for="floatingInput">Password (Leave blank if no change)</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
