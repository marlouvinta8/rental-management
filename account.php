...
include_once 'functions/views/account-profile.php';
?>
<!DOCTYPE html>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center d-flex flex-column align-items-center"><img class="rounded-circle" src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin" width="150">
                                <div class="mt-3">
                                    <h4><?= $level == 0 ? 'Administrator' : 'Landlord' ?></h4>
                                    <p class="text-secondary mb-1"><?= htmlspecialchars($fullname) ?></p>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary"><span><?= htmlspecialchars($email) ?></span></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
